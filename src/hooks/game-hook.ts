...
// To use real DB, set NEXT_PUBLIC_USE_MOCK=false in .env or change the default here.
const USE_MOCK = process.env.NEXT_PUBLIC_USE_MOCK === "true" || true; // Set to true by default for now as requested
